;; Taken from Malli sources, as the functionality was not easily extensible in a way
;; I could see, even though it uses multimethods they are not marked public and have changed
;; see 0.13 to 0.14, so unstable..
(ns com.fulcrologic.guardrails.malli.formatting
